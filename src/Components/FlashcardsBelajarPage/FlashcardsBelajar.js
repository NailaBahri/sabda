...
import {
  BackgroundContainer, Home, ReverseHint, PopupButton, PopupContainer, ButtonArea, Wrapper, CardFace, CardWrapper, CardInner,
  Controls, Front, Button3, Button4, Back, CardButton, Button1, Button2
} from './FlashcardsBelajarElements';
...
export default function FlashcardsBelajar()  {
  ...
  const handleLanjutGames = () => {
    setIsExiting(true);
    setTimeout(() => navigate('/gamebelajar'), 400);
  };
